    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-72 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-4 border-b border-gray-200">
          ...
          <div className="w-full flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#9379E3] via-[#5E70D2] to-[#3A4CB1] text-white rounded-lg">
            ...
            <div className="space-y-1">
              {conversations.map((conv) => (
                <button
                  ...
                  className="w-full text-left px-3 py-2.5 rounded-lg text-sm transition-colors truncate text-gray-700 hover:bg-gray-100"
                  title={conv.title}
                >
                  {conv.title}
                </button>
      ...
      <main className="flex-1 flex flex-col bg-white">
        <header className="px-6 py-3 border-b border-gray-200">
          <h1 className="font-semibold text-gray-800">Nueva conversación</h1>
        </header>
